...
This scheme contains either the domain name of a chatmail server.
...
In the past it also supported https endpoints that returned an account when an URL was used,
e.g. `DCACCOUNT:https://example.org/new_email?t=1w_7wDjgjelxeX884x96v3`,
but today it only takes the domain/host of these links and ignores the rest.
