...
- There must be an _authority_ section
  ...
  - The _host_ is a domain, but can also be an ip address, though note that the ip address needs to be delimited by square brackets (`test@[127.0.0.1]` or `test@[2001:0db8:85a3:0000:0000:8a2e:0370:7334]`).
